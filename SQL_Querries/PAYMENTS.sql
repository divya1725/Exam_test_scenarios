...
;
SELECT * FROM TRANSACTIONS WHERE TRANSACTIONSID IN (159609,159608,159607,159606)
--WHERE AGREEMENTID IN ( '10263','10263' ) ORDER BY TRANSACTIONSID DESC; --1000136346,1000136345
;
